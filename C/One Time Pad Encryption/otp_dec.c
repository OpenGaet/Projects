...
int main(int argc, char *argv[])
{
  ...
  // Get encrypted text from file, it will be stored in plaintext
  ...
  // Copy text, check for bad characters, unnecessary but cautionary
  int plainCount = 0;
  int plainTotal = 0;
  int i = 0;
